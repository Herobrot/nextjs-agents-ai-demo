...
import { entrevistadorPromptElevenLabs, entrevistadorVapi } from '../config/prompts/entrevistador';
...
export const getVapiPromptForUseCase = (useCase: keyof typeof vapiPrompts): string => {
