  ...
  useCases: {
    'atencion-cliente': {
      ...
      agentConfig: {
        ...
        firstMessage: 'Hola, soy tu asistente de atención al cliente. ¿En qué puedo ayudarte hoy?',
        voicemailMessage: 'Por favor, llama de nuevo cuando estés disponible.',
        endCallMessage: 'Gracias por contactarnos. ¡Que tengas un excelente día!',
    ...
    'asistente-virtual': {
      ...
      agentConfig: {
        ...
        firstMessage: '¡Hola! Soy tu asistente virtual. ¿En qué puedo ayudarte hoy?',
        voicemailMessage: 'Por favor, llama de nuevo cuando estés disponible.',
        endCallMessage: '¡Fue un placer ayudarte! ¡Hasta la próxima!',
        endCallPhrases: ['adiós', 'hasta luego', 'gracias', 'chao', 'nos vemos'],
    ...
    'narracion-contenidos': {
      ...
      agentConfig: {
        ...
        firstMessage: 'Bienvenido. Soy tu narrador profesional. ¿Qué contenido te gustaría que narre?',
        voicemailMessage: 'Por favor, llama de nuevo cuando estés disponible.',
    ...
    'atencion-cliente-computadoras': {
      ...
      agentConfig: {
        ...
        firstMessage: 'Hola, soy José de TecnoNeuro. ¿En qué puedo ayudarte con tu PC hoy?',
        voicemailMessage: 'Por favor, llama de nuevo cuando estés disponible.',
        endCallMessage: 'Gracias por contactar TecnoNeuro. ¡Esperamos ayudarte con tu próximo proyecto!',
        endCallPhrases: ['adiós', 'hasta luego', 'gracias', 'chao'],
    ...
    'entrevistador': {
      ...
      description: 'Entrevistadora de RRHH con control de tiempo estricto (90 segundos)',
      ...
      agentConfig: {
        ...
        firstMessage: 'Hola, soy María de TalentConnect. Gracias por tu tiempo. Tenemos 90 segundos para conocerte mejor. Empecemos: ¿Cuál ha sido tu logro profesional más importante y por qué?',
        voicemailMessage: 'Por favor, llama de nuevo cuando estés disponible.',
...
export type VapiUseCaseConfigType = typeof vapiConfig.useCases[VapiUseCaseKey];
