...
export const elevenLabsConfig = {  
  ...
  useCases: {
    ...
    'asistente-virtual': {
      ...
      firstMessage: '¡Hola! Soy tu asistente virtual personal. Estoy aquí para ayudarte con cualquier consulta que tengas. ¿Cómo puedo asistirte?',
      agentConfig: {        
        voiceSettings: {
          stability: 0.7,
          similarityBoost: 0.6,
    ...
    'narracion-contenidos': {
      ...
      firstMessage: 'Bienvenido. Soy tu narrador de contenidos. Estoy listo para comenzar la narración cuando me indiques.',
      agentConfig: {        
        voiceSettings: {
          stability: 0.8,
          similarityBoost: 0.7,
    ...
    'entrevistador': {
      ...
      agentConfig: {
        ...
        tools: [
          {
            name: 'end_interview',
            description: 'Finaliza la entrevista y cierra la llamada automáticamente',
            parameters: {
              reason: 'completed',
