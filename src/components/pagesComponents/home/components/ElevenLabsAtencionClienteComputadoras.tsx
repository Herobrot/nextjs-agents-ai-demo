    ...
    <div className="bg-gray-800 rounded-lg p-6 space-y-6">
          ...
          {conversationHistory.length === 0 ? (
            <div className="text-center py-8">
              <p className="text-gray-400 mb-2">
                ¡Hola! Soy José de TecnoNeuro
              </p>
              <p className="text-gray-500 text-sm">
                ¿En qué puedo ayudarte con tu PC hoy?
              </p>
            </div>
          ) : (
      ...
      <div className="bg-gray-900/50 rounded-lg p-4">
        ...
        <p className="text-xs text-gray-400">
          José es tu especialista en componentes de PC con amplia experiencia en
          CPU, GPU, placas base, RAM, almacenamiento y más. Te ayudará a
          encontrar la configuración perfecta para tus necesidades y
          presupuesto.
        </p>
      </div>
    </div>
