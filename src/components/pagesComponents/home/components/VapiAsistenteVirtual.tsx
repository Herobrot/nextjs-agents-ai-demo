    ...
    <div className="bg-gray-800 rounded-lg p-6 space-y-6">
        ...
        <div className="space-y-3">
          {conversationHistory.length === 0 ? (
            <p className="text-gray-400 text-center py-8">
              ¡Hola! Soy tu asistente virtual con VAPI. ¿En qué puedo ayudarte
              hoy?
            </p>
          ) : (
      ...
      <div className="bg-gray-900/50 rounded-lg p-4">
        ...
        <p className="text-xs text-gray-400">
          Este asistente virtual está diseñado para conversaciones generales con
          capacidades conversacionales avanzadas usando VAPI. Configura el
          agentId y el prompt inicial en el archivo de configuración para
