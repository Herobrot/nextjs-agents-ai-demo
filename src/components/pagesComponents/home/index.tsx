          ...
          <div className="text-center space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                ...
                Compara ElevenLabs y VAPI lado a lado o prueba cada plataforma
                individualmente.
              </p>
            </div>
          ...
          <div className="space-y-6">
            {selectedPlatform !== "comparison" && (
              <div className="text-center">
                <h2 className="text-2xl font-semibold text-white mb-2">
                  {selectedUseCase === "atencion-cliente" &&
                    "Atención al Cliente"}
                  {selectedUseCase === "atencion-cliente-computadoras" &&
                    "Atención al Cliente - Computadoras"}
                  {selectedUseCase === "asistente-virtual" &&
                    "Asistente Virtual"}
                ...
                <p className="text-gray-400">
                  {selectedUseCase === "atencion-cliente" &&
                    "Asistente profesional para soporte al cliente"}
                  {selectedUseCase === "atencion-cliente-computadoras" &&
                    "Especialista en hardware de PC (José de TecnoNeuro)"}
                  {selectedUseCase === "asistente-virtual" &&
                    "Asistente conversacional para tareas generales"}
                  {selectedUseCase === "narracion-contenidos" &&
            ...
            {selectedPlatform === "comparison" && (
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Compara ElevenLabs y VAPI en tiempo real con el mismo caso de
                  uso
                </p>
              </div>
            )}
            ...
            <div
              className={`mx-auto ${selectedPlatform === "comparison" ? "max-w-7xl" : "max-w-5xl"}`}
            >
              {renderComponent()}
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              <div className="transform hover:scale-105 transition-transform duration-300">
                <ComparisonCard title="Vapi" data={metrics.vapi} />
              </div>
              <div className="transform hover:scale-105 transition-transform duration-300">
                <ComparisonCard title="ElevenLabs" data={metrics.elevenlabs} />
              </div>
            </div>
          </div>
        </div>
